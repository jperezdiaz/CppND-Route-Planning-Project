...
RouteModel::Node *RoutePlanner::NextNode() {
    auto sort_function =  [](RouteModel::Node* n1, RouteModel::Node* n2){
        return (n1->g_value + n1->h_value) > (n2->g_value + n2->h_value);
    };
    std::sort(open_list.begin(), open_list.end(), sort_function);
    
    RouteModel::Node* next_node = open_list.back();
    open_list.pop_back();
//     for(RouteModel::Node* node: open_list){
//         std::cout << "Nodes: " << node->h_value << " | " << node->g_value << " | " << node->h_value + node->g_value<< "\n";
//     }
//     std::cout << "      NextNode: " << next_node->h_value << " | " << next_node->g_value << " | " << next_node->h_value + next_node->g_value<< "\n";
